...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="${scripts_path}/bootstrap/css/bootstrap.css?version=${resources_version}"/>
    <link type="text/css" rel="stylesheet"
          href="${scripts_path}/bootstrap/css/bootstrap-theme.css?version=${resources_version}"/>
    <!-- Font awesome icon -->
    <link type="text/css" rel="stylesheet"
          href="${styles_path}/font-awesome/css/font-awesome.css?version=${resources_version}"/>
    <!--[if IE 7]>
    <link type="text/css" rel="stylesheet"
    ...
    <script type="text/javascript"
            src="${scripts_path}/angular/angular-sanitize.js?version=${resources_version}"></script>
    <script type="text/javascript" src="${scripts_path}/angular/angular-route.js?version=${resources_version}"></script>
    <script type="text/javascript"
            src="${scripts_path}/angular-ui-bootstrap/ui-bootstrap-tpls-0.11.0.js?version=${resources_version}"></script>
    <script type="text/javascript"
            src="${scripts_path}/angular-ui-utils/ui-utils.js?version=${resources_version}"></script>
    <script type="text/javascript"
            src="${scripts_path}/angular-ui-select/select.js?version=${resources_version}"></script>
    <!--[if lte IE 8]>
    <script>
        window.myCustomTags = ['yourCustomDirective', 'somebodyElsesDirective']; // optional
    </script>
    <script type="text/javascript"
            src="${scripts_path}/angular-ui-utils/ui-utils-ieshiv.js?version=${resources_version}"></script>
    <![endif]-->
    <script type="text/javascript"
            src="${scripts_path}/angular-ui-router/angular-ui-router.js?version=${resources_version}"></script>
    <script type="text/javascript"
            src="${scripts_path}/angular-file-upload/angular-file-upload.js?version=${resources_version}"></script>

    <!-- bootstrap -->
    <script type="text/javascript"
            src="${scripts_path}/bootstrap/js/bootstrap.js?version=${resources_version}"></script>

    <!-- noty -->
    <script type="text/javascript"
            src="${scripts_path}/noty/packaged/jquery.noty.packaged.js?version=${resources_version}"></script>
    ...
    <script type="text/javascript"
            src="${scripts_path}/module-content-service.js?version=${resources_version}"></script>
